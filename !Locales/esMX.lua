...
L = BigWigs:NewBossLocale("Battle of Dazar'alor Trash", "esMX")
if L then
...
L = BigWigs:NewBossLocale("The Restless Cabal", "esMX")
if L then
	L.absorb = "Absorbido"
	--L.absorb_text = "%s (|cff%s%.0f%%|r)"
...
L = BigWigs:NewBossLocale("Maut", "esMX")
if L then
...
L = BigWigs:NewBossLocale("MOTHER", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Zek'voz, Herald of N'zoth", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Zul", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Mythrax the Unraveler", "esMX")
if L then
...
L = BigWigs:NewBossLocale("G'huun", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Uldir Trash", "esMX")
if L then
